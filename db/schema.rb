...
ActiveRecord::Schema.define(:version => 20111214211142) do
  ...
  create_table "user_groups_variants", :force => true do |t|
  ...
  add_index "user_groups_variants", ["user_group_id"], :name => "index_user_groups_variants_on_user_group_id"
  add_index "user_groups_variants", ["variant_id"], :name => "index_user_groups_variants_on_variant_id"
